...
class AuthController extends AsyncNotifier<AuthUser?> {
  ...
  Future<AuthUser?> build() async {
    ...
    _notificationRegistrationService = ref.watch(notificationRegistrationServiceProvider);
    final user = await _repository.restoreSession();
    if (user != null) unawaited(_notificationRegistrationService.registerDevice());
    return user;
  }
