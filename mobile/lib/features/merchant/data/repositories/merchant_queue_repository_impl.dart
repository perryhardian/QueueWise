...
final merchantQueueRepositoryProvider = Provider<MerchantQueueRepository>((
  ref,
) {
  return MerchantQueueRepositoryImpl(
    ref.watch(merchantQueueRemoteDataSourceProvider),
  );
});
...
class MerchantQueueRepositoryImpl implements MerchantQueueRepository {
  ...
  Future<List<MerchantQueueOverview>> getActiveQueues() =>
      _remoteDataSource.getActiveQueues();

  @override
  Future<MerchantQueueDashboard> getDashboard(String queueId) =>
      _remoteDataSource.getDashboard(queueId);

  @override
  Future<MerchantAnalytics> getAnalytics(String businessId) =>
      _remoteDataSource.getAnalytics(businessId);
  ...
  Future<void> callEntry(String entryId) =>
      _remoteDataSource.callEntry(entryId);

  @override
  Future<void> startService(String entryId) =>
      _remoteDataSource.startService(entryId);

  @override
  Future<void> completeService(String entryId) =>
      _remoteDataSource.completeService(entryId);

  @override
  Future<void> markNoShow(String entryId) =>
      _remoteDataSource.markNoShow(entryId);

  @override
  Future<void> skipEntry(String entryId) =>
      _remoteDataSource.skipEntry(entryId);
}
