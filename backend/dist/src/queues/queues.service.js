...
let QueuesService = class QueuesService {
    prisma;
    queueEventsService;
    constructor(prisma, queueEventsService) {
        this.prisma = prisma;
    ...
    async getBusinessCheckInQr(userId, businessId) {
...
exports.QueuesService = QueuesService = __decorate([
    ...
    __metadata("design:paramtypes", [prisma_service_1.PrismaService, queue_events_service_1.QueueEventsService])
], QueuesService);
