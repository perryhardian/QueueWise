...
const environment_validation_1 = require("./common/config/environment.validation");
const merchants_module_1 = require("./merchants/merchants.module");
const notifications_module_1 = require("./notifications/notifications.module");
const prisma_module_1 = require("./prisma/prisma.module");
const queue_entries_module_1 = require("./queue-entries/queue-entries.module");
...
exports.AppModule = AppModule = __decorate([
    (0, common_1.Module)({
        imports: [
            ...
            queue_entries_module_1.QueueEntriesModule,
